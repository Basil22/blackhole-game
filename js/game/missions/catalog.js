...
export const MISSION_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    description: 'Survive a pass within 1.5× the event horizon.',
    type: MISSION_TYPES.SURVIVE_NEAR_HORIZON,
    target: 1.5,
    difficulty: 3,
    recommendedObjectIds: Object.freeze(['ship', 'human']),
    hint: 'Close is not enough — the pass only counts if the whole object survived it.',
  },
  {
    id: 'score-01',
    title: 'Make It Count',
    ...
    difficulty: 2,
    recommendedObjectIds: Object.freeze(['rock', 'human']),
    hint: 'Different throws reward different categories — a close, stretched, surviving pass scores across all of them.',
  },
  {
    id: 'score-02',
    title: 'High Roller',
    ...
    hint: 'Stack every category — depth, stretch, tears, and survival — to crack 1,000.',
  },
]);
